...
<ul>
<li><a href="#there-has-always-been-a-make">There has always been a make</a></li>
<li><a href="#make-is-a-build-tool">Make is a build tool</a></li>
<li><a href="#i-wrote-a-makefile">I wrote a makefile</a></li>
...
<p>(The above snippet may be out of date even as soon as the publication of this post, but the <a href="https://github.com/chrisman/chrisman.github.io/blob/master/Makefile">current Makefile I’m using for this site can always be found on github</a>.)</p>
...
<dd>
Often refers to GNU Make. An ancient, language agnostic build tool which defines tasks, dependencies, and recipes. Used by C/C++ hackers of old. Not a <em>great</em> tool, but an extremely useful one, and installed everywhere, much like vim. An example of the worse-is-better?
</dd>
<dt>
Pandoc
</dt>
